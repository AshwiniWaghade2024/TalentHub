    ...
    <div className="dashboard-container">
      ...
      <div className="dash-sidebar">
        ...
        <ul className="sidebar-nav">
          ...
          <li className={activeTab === 'Employee' ? 'active' : ''} onClick={() => setActiveTab('Employee')}><UserGroupIcon /> Employee</li>
      ...
      <div className="dash-main">
        ...
        <div className="dash-content">
          {activeTab !== 'Attendance' && activeTab !== 'Payroll' && activeTab !== 'Performance' && activeTab !== 'Employee' && (
          ...
          {activeTab === 'Employee' && <Employee userData={userData} />}
